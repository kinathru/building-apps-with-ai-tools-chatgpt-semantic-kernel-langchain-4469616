...
async def main():
    ...
    prompt_prefix = """You are an order counting assistant. Summarize the list into product name and total quantity, thinking step by step. Then output into a JSON object. Only output the JSON, do not give an explanation.\n"""
    ...
    prompt = f"{prompt_prefix}{prompt_examples}" + f"{user_input}" + "\nOutput:\n"
    ...
    print(_unidiff_output(json.dumps(summary_result.content, indent=4), formatted_actual))
